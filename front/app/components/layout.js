  ...
  return (
    <>
      ...
      <div id="nav_header" className={`col-12 d-lg-none text-end drawerMenu ${openMenu ? 'open' : 'hidden'}`}>
        ...
        <Link href="" className='d-block nav-link' id="setting_small">SETTING</Link>
        <Link href="" className='d-block nav-link' id="logout_small">LOGOUT</Link>
        {/* 非ログイン時のみ表示 */}
        <Link href="" className='d-block nav-link' id="login_small">LOGIN</Link>
      </div>
    </>
  )
}