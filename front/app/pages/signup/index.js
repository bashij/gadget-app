        ...
        <div className="col-md-6 col-md-offset-3">
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              ...
              <span className="required-item">必須</span>
              <select name="job" id="id" className='form-control' onChange={handleChange} value={formData.job} required>
            ...
            <div className="mb-3">
              ...
              <input type="file" className='form-control' name='image' onChange={handleChange} value={formData.image}/>
            </div>
            <div className="mb-3">
              <label className="form-label">パスワード</label>
                {pageTitle === 'ユーザー登録' ? <span className="required-item">必須</span> : null }
                <input type="password" className='form-control' name='password' onChange={handleChange} value={formData.password} required={pageTitle === 'ユーザー登録' ? true : false}/>
            </div>
            <div className="mb-3">
            <label className="form-label">パスワード（確認）</label>
              {pageTitle === 'ユーザー登録' ? <span className="required-item">必須</span> : null }
              <input type="password" className='form-control' name='password_confirmation' onChange={handleChange} value={formData.password_confirmation} required={pageTitle === 'ユーザー登録' ? true : false}/>
            </div>
